...
const MessageHoverToolbar = ({ canEdit, messageId, onEdit }: toolbarProps) => {
  return (
    <div
      className="absolute -right-2 -top-3 items-center gap-1 rounded-md border border-gray-200 bg-white/95 px-1.5 py-1 shadow-sm backdrop-blur-md transition-opacity opacity-0 group-hover:opacity-100
