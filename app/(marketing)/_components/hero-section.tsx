            ...
            <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
              <div className="flex">
                <img
                  ...
                  src="https://blog.arcjet.com/assets/img/logo-lockup-spark-light.svg?v=40d0e3fe80"
                  alt="Arcjet Logo"
                  height="16"
                  width="auto"
                />
              ...
              <div className="flex">
                <img
                  className="mx-auto h-8 w-fit dark:invert font-xl"
                  src="prisma-2.svg"
                  alt="Prisma Logo"
                  height="16"
                  width="auto"
              ...
              <div className="flex">
                <img
                  className="mx-auto h-8 w-fit dark:revert"
